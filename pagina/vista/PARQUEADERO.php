...
<div>USO 
<select><option>OCUPADO</option>
<option>DISPONIBLE</option>
</select>
</div>
<input type="text"max-length="20"placeholder="ESTADO PARQUEADERO">
<div>TIPO DE PARQUADERO
<select><option>MOTO</option>
<option>CARRO</option>
</select>
</div>
<input type="text"max-length="20"placeholder="ID PARQUEADERO">
<center>
