...
<input type="text"max-length="20"placeholder="PLACA VEHICULO">
<input type="passwoard"max-length="20"placeholder="MODELO DEL VEHICULO">
<input type="text"max-length="20"placeholder="MARCA DE VEHICULO">
<input type="text"max-length="20"placeholder="COLOR DEL VEHICULO">
<input type="text"max-length="20"placeholder="ID VEHICULO">
<center>
