...
<select><option>CEDULA DE CUIDADANIA (CC)</option>
<option>TARJETA PASAPORTE (TP)</option>
<option>CEDULA DE EXTRANJERIA (CE)</option>
</select>
</div>
<input type="text"max-length="20"placeholder="NUMERO DE DOCUMENTO">
<input type="text"max-length="20"placeholder="NOMBRE DEL VISITANTE">
<input type="text"max-length="20"placeholder="APELLIDO DEL VISITANTE">
<div>TORRE
<select><option>TORRE 1</option>
...
<input type="time" HORA DE ENTRADA>
<input type="time" HORA DE SALIDA>

<center>
    <button type="button"> REGISTRAR</button>
    <button type="button">MODIFICAR</button>
    <button type="button">CONSULTAR</button>
    <button type="button">INHABILITAR</button></center>
      </form>
        <div class="button">
